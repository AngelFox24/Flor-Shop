...
final class RegisterUserInteractor: RegisterUserUseCase {
    ...
    init(createCompanyUseCase: CreateCompanyUseCase, createSubsidiaryUseCase: CreateSubsidiaryUseCase, createEmployeeUseCase: CreateEmployeeUseCase, setDefaultCompanyUseCase: SetDefaultCompanyUseCase, setDefaultSubsidiaryUseCase: SetDefaultSubsidiaryUseCase, setDefaultEmployeeUseCase: SetDefaultEmployeeUseCase) {
