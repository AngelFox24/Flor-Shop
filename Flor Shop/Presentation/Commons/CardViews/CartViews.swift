...
struct CardViews_Previews: PreviewProvider {
    static var previews: some View {
        ...
        VStack(spacing: 10, content: {
            ...
            let cartDetail = CartDetail(id: UUID(), quantity: 24, subtotal: Money(cents: 3400), product: Product(id: UUID(uuidString: "3062F3B7-14C7-4314-B342-1EC912EBD925") ?? UUID(), active: true, barCode: "", name: "AUDIFONOS C NOISE CANCELLING 1000XM4BMUC", qty: 23, unitType: UnitTypeEnum.unit, unitCost: Money(cents: 2340), unitPrice: Money(cents: 1240), expirationDate: Date(), image: ImageUrl(id: UUID(), imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRenBX4ycM2_FQOz3IYXI1Waln52auoUqqdVQ&usqp=CAU", imageHash: "")))
