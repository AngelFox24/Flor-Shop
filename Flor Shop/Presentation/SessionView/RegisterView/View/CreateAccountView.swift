            ...
            VStack(content: {
                ...
                ScrollView {
                    VStack(spacing: 30) {
                        VStack(spacing: 40){
                            VStack {
                                CustomTextField(title: "Correo" ,value: $registrationViewModel.registrationFields.email, edited: $registrationViewModel.registrationFields.emailEdited, focusField: .agregar(.barcode), currentFocusField: $currentFocusField)
                            ...
                            VStack {
                                CustomTextField(title: "Usuario" ,value: $registrationViewModel.registrationFields.user, edited: $registrationViewModel.registrationFields.userEdited, focusField: .agregar(.margin), currentFocusField: $currentFocusField)
                            ...
                            VStack {
                                CustomTextField(title: "Contraseña" ,value: $registrationViewModel.registrationFields.password, edited: $registrationViewModel.registrationFields.passwordEdited, focusField: .agregar(.quantity), currentFocusField: $currentFocusField)
                            ...
                            HStack {
                                VStack {
                                    CustomTextField(title: "Nombre de la Tienda" ,value: $registrationViewModel.registrationFields.companyName, edited: $registrationViewModel.registrationFields.companyNameEdited, focusField: .agregar(.margin), currentFocusField: $currentFocusField)
                            ...
                            VStack {
                                CustomTextField(title: "Nombre del Dueño" ,value: $registrationViewModel.registrationFields.managerName, edited: $registrationViewModel.registrationFields.managerNameEdited, focusField: .agregar(.disponible), currentFocusField: $currentFocusField)
                            ...
                            VStack {
                                CustomTextField(title: "Apellidos del Dueño" ,value: $registrationViewModel.registrationFields.managerLastName, edited: $registrationViewModel.registrationFields.managerLastNameEdited, focusField: .agregar(.margin), currentFocusField: $currentFocusField)
